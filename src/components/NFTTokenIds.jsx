    ...
    <>
      <div>
        {contractABIJson.noContractDeployed && (
          <>
            <Alert message="No Smart Contract Details Provided. Please deploy smart contract and provide address + ABI in the MoralisDappProvider.js file"
                  type="error"
            />
        ...
        { /* selected collection's summary */ }
        {inputValue !== "explore" && totalNFTs !== undefined && (
          <>
            {!fetchSuccess && (
              <>
                <Alert message="Unable to fetch all NFT metadata... We are searching for a solution, please try again later!"
                      type="warning"
                />
                <div style={{ marginBottom: "10px" }}></div>
              </>
        ...
        <div style={styles.NFTs}>
          { /* list collections on chain */ }
          {inputValue === "explore" && NFTCollections?.map((nft, index) => (
            <Card hoverable
                  actions={[
          ...
          { /* list all nfts in selected collection */ }
          {inputValue !== "explore" && NFTTokenIds.map((nft, index) => (
            <Card hoverable
                  actions={[
        ...
        {getMarketItem(nftToBuy) ? (
          <Modal title={`Buy ${nftToBuy?.name} #${nftToBuy?.token_id}`}
                visible={visible}
              ...
              <div style={ { width: "250px", margin: "auto" } }>
                <Badge.Ribbon color="green" text={`${getMarketItem(nftToBuy).price / ("1e" + 18)} ${nativeName}`}>
                  <img src={nftToBuy?.image} 
                        style={ { width: "250px", borderRadius: "10px", marginBottom: "15px" } } alt={""}
                  />
                </Badge.Ribbon>
              </div>
            </Spin>
          ...
          >
            <img src={nftToBuy?.image}
                  style={ { width: "250px", margin: "auto", borderRadius: "10px", marginBottom: "15px" } } alt={""}
            />
